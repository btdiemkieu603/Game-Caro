...
public class User {
    ...
    public User(int ID, String username, String password, String nickname, int numberOfGame, int numberOfwin, int numberOfDraw, boolean isOnline, boolean isPlaying) { //, String avatar , int rank
        this.ID = ID;
