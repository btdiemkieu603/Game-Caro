...
public class ServerThread implements Runnable {
    ...
    public String getStringFromUser(User user1){
        return ""+user1.getID()+","+user1.getUsername()
                                ...
                                ","+user1.getNumberOfGame()+","+                                    //user1.getAvatar()+
            ...
            while (!isClosed) {
                ...
                if(messageSplit[0].equals("register")){
                   ...
                   if(checkdup) write("duplicate-username,");
                       ...
                       User userRegister = new User(messageSplit[1], messageSplit[2], messageSplit[3]);  //, messageSplit[4]   //avatar
...
//                       write("login-success,"+getStringFromUser(this.user));
                ...
                //xử lý đóng game, bắt đầu ván mới khi người chơi quá thời gian
