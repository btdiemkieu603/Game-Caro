...
public class SocketHandle implements Runnable {
    ...
    public User getUserFromString(int start, String[] message){
        return new User(Integer.parseInt(message[start]),
                ...
                message[start+2],
                message[start+3],
                //message[start+4],  //avatar
                //Integer.parseInt(message[start+5]),    //rank
    ...
    public void run() {
        ...
        try {
            ...
            socketOfClient = new Socket("127.0.0.1", 4444);
            ...
            while (true) {
                ...
                if(messageSplit[0].equals("login")){
                    ...
                    JOptionPane.showMessageDialog(Client.registerFrm, "Đăng kí thành công! Hãy đăng nhập!");
                ...
                if(messageSplit[0].equals("check-friend-response")){
                    if(Client.gameClientFrm!=null){
                        Client.gameClientFrm.checkFriend((messageSplit[1].equals("1")));
                    }
                }
...
//                    
//                    JOptionPane.showMessageDialog(Client.gameClientFrm, "Đối thủ đồng ý kết bạn");
//                     
//                    Client.gameClientFrm.checkFriend(true);
//                   
//                    
//                }
